...
//    public static $rightname = 'glpi_plugin_wazuh_dbs_serverconnections';
  ...
  /**
    ...
    public static function getMenuContent()
    {
        ...
        if (\Config::canUpdate()) {
            ...
            $menu['page']  = '/' . \Plugin::getWebDir('wazuh', false) . '/front/application.php';
    ...
    private function prepareInput($input) {
        if (array_key_exists('name', $input) && empty(trim($input['name']))) {
            Session::addMessageAfterRedirect(__('Name cannot be empty', 'wazuh'), false, ERROR);
    ...
    public function getSpecificMassiveActions($checkitem = null) {
        ...
        $actions['ServerConnection:your_action'] = __('Your action name', 'wazuh');
        $actions['ServerConnection:another_action'] = __('Another action', 'wazuh');
     ...
     static function showMassiveActionsSubForm(\MassiveAction $ma) {
         switch ($ma->getAction()) {
            ...
            case 'ServerConnection:another_action':
                ...
                echo Html::submit(_x('button', 'Execute'), ['name' => 'massiveaction']);
                return true;
        }
   ...
   static function processMassiveActionsForOneItemtype(\MassiveAction $ma, \CommonDBTM $item,
    ...
    public function showForm($ID, array $options = []) {
        ...
        TemplateRenderer::getInstance()->display('@wazuh/server_connection.form.twig', [
            'item'   => $this,
            'params' => $options,
...
//        \src\Logger::addDebug('Form url: ' . $url);
//        return $url;
...
//            'name' => self::class
//        ];
//        \src\Logger::addDebug('Show form: ' . $contentFile);
